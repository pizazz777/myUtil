package com.huang.util.word;

import com.google.common.collect.Lists;
import com.google.common.collect.Maps;
import com.huang.util.container.ContainerUtil;
import com.huang.exception.WordException;
...
public class WordUtil {
     ...
     */
    public static void downloadDateToWord(List<Map<String, Serializable>> dataMapList, OutputStream outputStream, String path) throws IOException {
        // 判断要导出的数据是否为空
